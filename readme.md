...
### HTML - это гипертекстовая разметка, которая использует теги для оформления веб страницы
### Браузеры, получая HTML документ, проходят этапы рендеринга: 
- Загрузка HTML 
- Построение DOM 
- Построение CSS Object Model
- Формирования Render Tree
- Layout 
- Отрисовка 
---
